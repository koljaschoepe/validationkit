...
> Status: ✅ Done — 2026-05-19 (Sprint G1–G6 shipped). Diese Datei ist Archiv.
> Master-Plan: [docs/plans/done/master-vision-galaxie.md](../../plans/done/master-vision-galaxie.md).
> Vision: [docs/vision.md](../../vision.md).
> Pivot 2026-05-20: Landing-Hero wurde von Pixi auf SVG migriert (siehe [ADR-0004](../../adrs/0004-landing-svg-stack.md)). Workspace-Galaxie unverändert auf PixiJS.

> **Mai-2026 Pivot (historisch):** Repo-Compare/Drift-Detection wurde im Homepage-Relaunch abgebaut (siehe `docs/adrs/0003-drop-compare-feature.md`). Multi-Repo bleibt.
