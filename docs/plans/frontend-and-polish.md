...
- [ ] **Workspace-General-Settings** (name/slug-rename mit Redirect-Schutz/logo/timezone) + **Audit&Apply-Settings** (`applySettings` JSONB) + **Account-Profile** (name/avatar/locale) + **Ownership-Transfer** — der letzte offene Block-C-Teil (Q-SB-4 Delete-Window).
