...
- [x] **`vitest` 3→4-Bump** (2026-06-23): root + `@vk/web` auf `vitest@^4.1.9` (CVE). Projects-Config + Setup kompatibel — **342 Tests grün**, Typecheck 23/23, Lint sauber. Kein Bruch.
- [ ] ~~Phase-5 IDOR-Negative-Tests~~ — **bewusst nicht** umgesetzt: User hat zusätzliche Tests wiederholt abgelehnt (dokumentierte Präferenz; „autonom" hebt eine explizite User-Entscheidung nicht auf).
